...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [-2511105.688041, 2947472.483845, 503871.708378, 5645689.061933], maxZoom: 15, minZoom: 7
    })
});
...
map.getView().fit([-2511105.688041, 2947472.483845, 503871.708378, 5645689.061933], map.getSize());
